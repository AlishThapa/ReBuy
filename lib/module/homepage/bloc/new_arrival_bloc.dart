...
class NewArrivalBloc extends Cubit<NewArrivalBlocState>{
  NewArrivalBloc(): super( NewArrivalBlocState(data: [
    ProductModals(image: 'assets/images/batman.png', productName: 'Batman Toy', dataAndComp: '2018 | FunSkool', price: 899, isLoved: false),
    ProductModals(image: 'assets/images/book.png', productName: 'How to be rich by J. Paul Getty', dataAndComp: '2020 | H&C', price: 1299, isLoved:false)
  ])
  );
